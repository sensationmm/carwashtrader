...
<div class="summaryRow">
    <div class="summaryBox summaryBox4">
        <h4>Car Washes</h4>
        <?php $carwashes = query_posts(array('post_type' => 'cwt_carwashes', 'posts_per_page' => -1, author => $current_user->ID)); ?>
        <div class="summaryCount">
            <?php 
                if(sizeof($carwashes) > 999)
                    echo '<span style="font-size:0.8em;line-height:1.8;">'.sizeof($carwashes).'</span>';
                else
                    echo sizeof($carwashes); 
            ?>
        </div>
    </div>
    <div class="summaryBox summaryBox4">
